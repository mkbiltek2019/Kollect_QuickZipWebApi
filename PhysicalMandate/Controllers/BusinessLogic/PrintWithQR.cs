...
{
    public static class PrintWithQR
    {
        public static string PrintWIthQR(string MandateId, string AppId)
        {
            string PDFBase64 = "";
            try
            { string temppath = System.Web.Hosting.HostingEnvironment.MapPath("~");
                ...
                //if (result == "1")
                //{
                FileStream fs = new FileStream(filePath + "/MandateQrcode/"+AppId+"/" + ID + ".png", FileMode.Open, FileAccess.Read);
